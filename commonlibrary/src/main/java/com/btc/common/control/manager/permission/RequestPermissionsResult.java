...
@Accessors(prefix = "_")
public class RequestPermissionsResult extends EventArgs {
    @NonNull
    public static RequestPermissionsResult allGranted(@NonNull final List<String> permissions) {
    ...
    @NonNull
    public static RequestPermissionsResult allDenied(@NonNull final List<String> permissions) {
        Contracts.requireNonNull(permissions, "permissions == null");
    ...
    @NonNull
    public static RequestPermissionsResult from(
        ...
        return new RequestPermissionsResult(
            deniedPermissions,
            grantedPermissions,
    ...
    public boolean isAllGranted() {
        return !getGrantedPermissions().isEmpty() && getDeniedPermissions().isEmpty() &&
               getUnrequestedPermissions().isEmpty();
    }

    protected RequestPermissionsResult(
        @NonNull final List<String> deniedPermissions,
        @NonNull final List<String> grantedPermissions,
        @NonNull final List<String> neverAskAgainPermissions,
        @NonNull final List<String> unrequestedPermissions) {
